      ...
      <div>
        <header className="header">
          <div className="links">
            ...
            <p><a href="https://github.com/B-P-Coders/coding-night/releases/download/1.3/Schoo4u-win32-ia32.zip" download className="windows" target="_blank"><i class="fa-brands fa-windows "></i> Windows</a></p>
            ...
            <p><a href="https://github.com/B-P-Coders/coding-night/releases/download/1.3/Schoo4u-linux-x64.zip" download className="linux" target="_blank"><i class="fa-brands fa-linux"></i> Linux</a></p>
          </div>
